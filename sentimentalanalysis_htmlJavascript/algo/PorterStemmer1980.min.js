...
var stemmer = (function () {
  ...
  return function (a, l) {
    ...
    b = /^(.+?)([^s])s$/;
    c.test(a)
      ? ((a = a.replace(c, "$1$2")), e("1a", c, a))
      : b.test(a) && ((a = a.replace(b, "$1$2")), e("1a", b, a));
    c = /^(.+?)eed$/;
    b = /^(.+?)(ed|ing)$/;
    c.test(a)
      ? ((b = c.exec(a)),
        (c = /^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*/),
        c.test(b[1]) && ((c = /.$/), (a = a.replace(c, "")), e("1b", c, a)))
      : b.test(a) &&
        ((b = b.exec(a)),
        (d = b[1]),
        ...
        b.test(d) &&
          ...
          b.test(a)
            ? ((a += "e"), e("1b", b, a))
            : f.test(a)
            ? ((c = /.$/), (a = a.replace(c, "")), e("1b", f, a))
            : d.test(a) && ((a += "e"), e("1b", d, a))));
    c = /^(.*[aeiouy].*)y$/;
